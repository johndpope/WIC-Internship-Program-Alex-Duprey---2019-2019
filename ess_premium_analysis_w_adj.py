...
def premium_analysis_df_OLS(alpha_ticker, peer_ticker_list, calib_data,analyst_upside, as_of_dt, price_tgt_dt, metrics,metric2weight, api_host, adjustments_df):
